...
import {
  ...
  Bell, Settings, User, LogOut, ChevronRight, Mail, Calendar, Copy,
  Download, Share2, Heart, Star, Eye, EyeOff, ArrowRight, Loader2,
...
export default function ComponentsPage() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        title="Components"
        description="Reusable UI components used across the admin panel"
      />
        ...
        <CardContent className="space-y-6">
          <div>
            ...
            <nav className="flex items-center gap-1.5 text-sm text-muted-foreground">
              ...
              <Link href="/resources/components" className="hover:text-foreground transition-colors">Resources</Link>
              <ChevronRight className="h-3.5 w-3.5" />
            ...
            <nav className="flex items-center gap-1.5 text-sm text-muted-foreground">
              {[
                ...
                <Fragment key={i}>
                  ...
                  {crumb.icon ? (
                    <Link href={crumb.href!} className="hover:text-foreground transition-colors"><Home className="h-4 w-4" /></Link>
                  ) : crumb.href ? (
        ...
        <CardContent className="space-y-6">
          <div>
            ...
            <div className="flex items-end gap-4">
              ...
              <div className="text-center">
                <Avatar className="h-10 w-10"><AvatarFallback className="text-sm">MD</AvatarFallback></Avatar>
                <p className="text-[10px] text-muted-foreground mt-1">40px</p>
              </div>
              <div className="text-center">
                <Avatar className="h-12 w-12"><AvatarFallback className="text-base">LG</AvatarFallback></Avatar>
                <p className="text-[10px] text-muted-foreground mt-1">48px</p>
              </div>
              <div className="text-center">
                <Avatar className="h-16 w-16"><AvatarFallback className="text-xl">XL</AvatarFallback></Avatar>
                <p className="text-[10px] text-muted-foreground mt-1">64px</p>
              </div>
            </div>
          </div>
          <Separator />
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-xs text-muted-foreground mt-1">Basic card with content</p>
              </CardContent>
            </Card>
            <Card>
            ...
            <Card className="border-primary/30 bg-primary/5">
              <CardContent className="p-4">
                ...
                <p className="text-xs text-muted-foreground mt-1">With custom border and background</p>
              </CardContent>
            </Card>
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <Checkbox id="c1" defaultChecked /><Label htmlFor="c1" className="font-normal">Checked</Label>
              </div>
              <div className="flex items-center space-x-2">
                <Checkbox id="c2" /><Label htmlFor="c2" className="font-normal">Unchecked</Label>
              </div>
              <div className="flex items-center space-x-2">
                <Checkbox id="c3" disabled /><Label htmlFor="c3" className="font-normal text-muted-foreground">Disabled</Label>
              </div>
            </div>
          </div>
          <Separator />
          <div>
            ...
            <RadioGroup value={radioVal} onValueChange={setRadioVal} className="space-y-2">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="option1" id="r1" /><Label htmlFor="r1" className="font-normal">Option One</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="option2" id="r2" /><Label htmlFor="r2" className="font-normal">Option Two</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="option3" id="r3" /><Label htmlFor="r3" className="font-normal">Option Three</Label>
              </div>
            </RadioGroup>
          </div>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent className="space-y-4 max-w-lg">
          <div className="space-y-1">
            <div className="flex justify-between text-sm"><span>Complete</span><span>100%</span></div>
            <Progress value={100} className="h-2" />
          </div>
          <div className="space-y-1">
            <div className="flex justify-between text-sm"><span>In Progress</span><span>72%</span></div>
            <Progress value={72} className="h-2" />
          </div>
          <div className="space-y-1">
            <div className="flex justify-between text-sm"><span>Starting</span><span>15%</span></div>
            <Progress value={15} className="h-2" />
          </div>
          <div className="space-y-1">
            <div className="flex justify-between text-sm"><span>Empty</span><span>0%</span></div>
        ...
        <CardContent className="space-y-6">
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger className="inline-flex items-center justify-center rounded-md border border-input bg-background px-3 h-8 text-sm font-medium hover:bg-accent hover:text-accent-foreground transition-colors">Hover me (top)</TooltipTrigger>
                  <TooltipContent side="top">Tooltip on top</TooltipContent>
                </Tooltip>
                <Tooltip>
                  <TooltipTrigger className="inline-flex items-center justify-center rounded-md border border-input bg-background px-3 h-8 text-sm font-medium hover:bg-accent hover:text-accent-foreground transition-colors">Hover me (right)</TooltipTrigger>
                  <TooltipContent side="right">Tooltip on right</TooltipContent>
                </Tooltip>
                <Tooltip>
                  <TooltipTrigger className="inline-flex items-center justify-center rounded-md border border-input bg-background px-3 h-8 text-sm font-medium hover:bg-accent hover:text-accent-foreground transition-colors">Hover me (bottom)</TooltipTrigger>
              ...
              <PopoverContent className="w-72">
                <div className="space-y-2">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input placeholder="email@example.com" className="h-8 text-sm" />
                  </div>
                </div>
              </PopoverContent>
            </Popover>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-3">
            ...
            <Button variant="outline" onClick={() => setConfirmOpen(true)}>
              <Trash2 className="mr-2 h-4 w-4" />Confirm Dialog
            </Button>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-3">
          <div className="flex items-start gap-3 rounded-lg border p-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">This is an informational message for the user.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 rounded-lg border border-warning/30 bg-warning/5 p-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Your trial period is about to expire in 3 days.</p>
            </div>
          </div>
          <div className="flex items-start gap-3 rounded-lg border border-danger/30 bg-danger/5 p-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Failed to process payment. Please try again.</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          ...
          <p className="text-sm text-muted-foreground">
            This is a dialog component. It can be used for confirmations, forms, or displaying important information that requires user attention.
          </p>
          <DialogFooter>
      ...
      <Sheet open={sheetOpen} onOpenChange={(open) => setSheetOpen(open)}>
        <SheetContent side="right" className="w-[400px] p-6">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            This is a side sheet / drawer component. It slides in from the right and can contain forms, details, or navigation.
          </p>
