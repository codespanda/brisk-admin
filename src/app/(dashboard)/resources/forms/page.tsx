...
export default function FormsPage() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        title="Forms"
        description="Form fields, labels, inputs and validation patterns"
      />
        ...
        <form onSubmit={methods.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <CardContent className="space-y-6">
              <div className="grid gap-6 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="native-text">Text Input</Label>
                  <Input id="native-text" placeholder="Basic input" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="native-search">Search Input</Label>
                  <Input id="native-search" type="search" placeholder="Search..." />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="native-url">URL Input</Label>
                  <Input id="native-url" type="url" placeholder="https://example.com" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="native-tel">Phone Input</Label>
                  <Input id="native-tel" type="tel" placeholder="+1 555-0100" />
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="native-textarea">Native Textarea</Label>
                <Textarea id="native-textarea" placeholder="Write something here..." rows={3} />
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="disabled-check" className="font-normal text-muted-foreground">Disabled checkbox</Label>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label>Required Label <span className="text-danger ml-0.5">*</span></Label>
                  <Input placeholder="Required field" />
                </div>
                <div className="space-y-2">
                  <Label>With Error</Label>
                  <Input placeholder="Invalid value" className="border-danger" />
                  <p className="text-sm text-danger">This field is required</p>
                </div>
                <div className="space-y-2">
                  <Label>With Helper Text</Label>
                  <Input placeholder="Enter value" />
                  <p className="text-sm text-muted-foreground">This is a helper text for guidance</p>
                </div>
              </div>
            </CardContent>
          </Card>
