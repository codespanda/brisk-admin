...
export default function ChartsPage() {
  return (
    <div className="space-y-8">
      <PageHeader title="Charts" description="Chart components available for data visualization" />

      <div className="grid gap-6 lg:grid-cols-2">
        <ChartCard title="Line Chart" subtitle="Revenue vs Expenses over time">
          <LineChart data={lineData} xAxisKey="month" series={[
        ...
        <ChartCard title="Area Chart" subtitle="Users & Sessions growth">
          <AreaChart data={areaData} xAxisKey="month" series={[
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <ChartCard title="Bar Chart" subtitle="Sales by category">
          <BarChart data={barData} xAxisKey="category" dataKey="sales" color="var(--color-chart-2)" />
        </ChartCard>
        <ChartCard title="Horizontal Bar Chart" subtitle="Top products by revenue">
          <HorizontalBarChart data={horizontalBarData} xAxisKey="name" dataKey="revenue" color="var(--color-primary)" />
        </ChartCard>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <ChartCard title="Stacked Area Chart" subtitle="New vs Returning users">
          <AreaChart data={areaData} xAxisKey="month" stacked series={[
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <ChartCard title="Single Area" subtitle="Smooth area with gradient">
          <AreaChart data={lineData} xAxisKey="month" series={[
