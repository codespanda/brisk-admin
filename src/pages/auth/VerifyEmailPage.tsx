    ...
    return (
      <AuthCard title="Email verified" description="Your email has been successfully verified">
        <div className="flex flex-col items-center py-4">
          ...
          <Link to="/"><Button className="mt-6">Go to Dashboard</Button></Link>
        </div>
      </AuthCard>
    )
  }
      ...
      <FormProvider {...methods}>
        <form onSubmit={methods.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="code" placeholder="123456" maxLength={6} className="text-center text-lg tracking-widest" {...methods.register('code')} />
            {methods.formState.errors.code && <p className="text-sm text-danger">{methods.formState.errors.code.message}</p>}
          </div>
